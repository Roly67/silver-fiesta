// <copyright file="ConvertMarkdownToPdfCommandHandlerTests.cs" company="FileConversionApi">
// FileConversionApi
// </copyright>
...
/// <summary>
/// Unit tests for <see cref="ConvertMarkdownToPdfCommandHandler"/>.
/// </summary>
public class ConvertMarkdownToPdfCommandHandlerTests
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConvertMarkdownToPdfCommandHandlerTests"/> class.
    /// </summary>
    public ConvertMarkdownToPdfCommandHandlerTests()
    {
        ...
        this.handler = new ConvertMarkdownToPdfCommandHandler(
    ...
    public async Task Handle_WhenConversionIsSuccessful_ReturnsSuccessWithJobDto()
    {
        ...
        this.converterFactoryMock
            .Setup(x => x.GetConverter("markdown", "pdf"))
        ...
        this.converterFactoryMock.Verify(x => x.GetConverter("markdown", "pdf"), Times.Once);
