// <copyright file="ConvertHtmlToImageCommand.cs" company="FileConversionApi">
// FileConversionApi
// </copyright>
...
/// <summary>
/// Command to convert HTML to image (PNG, JPEG, or WebP).
/// </summary>
public record ConvertHtmlToImageCommand : IRequest<Result<ConversionJobDto>>, IConversionCommand
{
    /// <summary>
