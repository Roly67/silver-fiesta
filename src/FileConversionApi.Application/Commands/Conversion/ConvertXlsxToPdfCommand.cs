// <copyright file="ConvertXlsxToPdfCommand.cs" company="FileConversionApi">
// FileConversionApi
// </copyright>
...
/// <summary>
/// Command to convert an XLSX (Excel) spreadsheet to PDF.
/// </summary>
public record ConvertXlsxToPdfCommand : IRequest<Result<ConversionJobDto>>, IConversionCommand
{
    /// <summary>
